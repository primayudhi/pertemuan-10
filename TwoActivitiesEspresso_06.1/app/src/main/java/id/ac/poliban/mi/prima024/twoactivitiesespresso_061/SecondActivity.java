package id.ac.poliban.mi.prima024.twoactivitiesespresso_061;
...
public class SecondActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY ="id.ac.poliban.mi.prima024.twoactivitiesespresso_061.extra.REPLY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("TwoActivities Received_024 PRIMA-E020320024");
