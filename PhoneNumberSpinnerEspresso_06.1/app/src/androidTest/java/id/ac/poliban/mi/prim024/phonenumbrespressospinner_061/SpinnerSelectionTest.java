package id.ac.poliban.mi.prim024.phonenumbrespressospinner_061;
...
public class SpinnerSelectionTest {
    ...
    public void spinnerSelectionTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editText_main),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("12384588855"), closeSoftKeyboard());

        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editText_main), withText("12384588855"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.editText_main),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("233"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.editText_main), withText("233"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
