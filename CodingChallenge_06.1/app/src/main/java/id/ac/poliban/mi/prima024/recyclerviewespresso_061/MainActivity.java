package id.ac.poliban.mi.prima024.recyclerviewespresso_061;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("RecyclerView EspressoTest_024 PRIMA-E020320024");
